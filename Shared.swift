...
let OPTIMISATION_PORT_ID = "com.ziben.Clop.optimisationService"
let OPTIMISATION_STOP_PORT_ID = "com.ziben.Clop.optimisationServiceStop"
let OPTIMISATION_RESPONSE_PORT_ID = "com.ziben.Clop.optimisationServiceResponse"
let OPTIMISATION_CLI_RESPONSE_PORT_ID = "com.ziben.Clop.optimisationServiceResponseCLI"
...
func runningClopApp() -> NSRunningApplication? {
    NSRunningApplication.runningApplications(withBundleIdentifier: "com.ziben.Clop-setapp").first
        ?? NSRunningApplication.runningApplications(withBundleIdentifier: "com.ziben.Clop").first
}
...
let LOG_SUBSYSTEM = Bundle.main.bundleIdentifier ?? "com.ziben.Clop"
...
let APP_SCRIPTS_DIR = FileManager.default.urls(for: .applicationScriptsDirectory, in: .userDomainMask).first ?? URL(fileURLWithPath: "\(NSHomeDirectory())/Library/Application Scripts/com.ziben.Clop")

let GLOBAL_BIN_DIR_PARENT = APP_SCRIPTS_DIR // ~/Library/Application Scripts/com.ziben.Clop
let GLOBAL_BIN_DIR = GLOBAL_BIN_DIR_PARENT.appendingPathComponent("bin") // ~/Library/Application Scripts/com.ziben.Clop/bin/
let BIN_DIR = GLOBAL_BIN_DIR.appendingPathComponent(ARCH) // ~/Library/Application Scripts/com.ziben.Clop/bin/arm64
